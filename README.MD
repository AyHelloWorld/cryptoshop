...
- use unsecured algorithms like MD5 or SHA-1 etc...
- bad use the encryption mode. Reuse nonce for same key, fixed initialization vector when it must be random etc...
